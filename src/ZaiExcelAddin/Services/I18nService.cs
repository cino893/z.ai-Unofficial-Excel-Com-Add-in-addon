    ...
    private void AddExtraKeys()
    {
        var extras = new Dictionary<string, Dictionary<string, string>>
        {
            ...
            ["pl"] = new()
            {
                ...
                ["error.balance_empty"] = "[!] Twoje saldo API jest puste.\nDoładuj tokeny na z.ai, aby kontynuować korzystanie z asystenta AI.",
                ["error.content_filter"] = "[!] Twoja wiadomość została zablokowana przez filtr treści.\nPrzeformułuj i spróbuj ponownie.",
                ["error.invalid_key"] = "[!] Nieprawidłowy klucz API.\nSprawdź klucz i zaloguj się ponownie.",
                ["error.rate_limit"] = "[!] Zbyt wiele zapytań.\nPoczekaj chwilę i spróbuj ponownie.",
                ["error.api_generic"] = "[!] Wystąpił błąd API.",
            ...
            ["de"] = new()
            {
                ...
                ["error.balance_empty"] = "[!] Ihr API-Guthaben ist leer.\nBitte laden Sie Tokens auf z.ai auf.",
                ["error.content_filter"] = "[!] Ihre Nachricht wurde vom Inhaltsfilter blockiert.",
                ["error.invalid_key"] = "[!] Ungültiger API-Schlüssel.",
                ["error.rate_limit"] = "[!] Zu viele Anfragen. Bitte warten.",
                ["error.api_generic"] = "[!] Ein API-Fehler ist aufgetreten.",
            ...
            ["fr"] = new()
            {
                ...
                ["error.balance_empty"] = "[!] Votre solde API est vide.\nRechargez vos tokens sur z.ai.",
                ["error.content_filter"] = "[!] Votre message a été bloqué par le filtre.",
                ["error.invalid_key"] = "[!] Clé API invalide.",
                ["error.rate_limit"] = "[!] Trop de requêtes. Veuillez patienter.",
                ["error.api_generic"] = "[!] Une erreur API s'est produite.",
            ...
            ["es"] = new()
            {
                ...
                ["error.balance_empty"] = "[!] Su saldo API está vacío.\nRecargue tokens en z.ai.",
                ["error.content_filter"] = "[!] Su mensaje fue bloqueado por el filtro.",
                ["error.invalid_key"] = "[!] Clave API inválida.",
                ["error.rate_limit"] = "[!] Demasiadas solicitudes. Espere un momento.",
                ["error.api_generic"] = "[!] Ocurrió un error de API.",
            ...
            ["uk"] = new()
            {
                ...
                ["error.balance_empty"] = "[!] Ваш баланс API порожній.\nПоповніть токени на z.ai.",
                ["error.content_filter"] = "[!] Ваше повідомлення заблоковано фільтром контенту.",
                ["error.invalid_key"] = "[!] Недійсний ключ API.",
                ["error.rate_limit"] = "[!] Забагато запитів. Зачекайте.",
                ["error.api_generic"] = "[!] Помилка API.",
            ...
            ["zh"] = new()
            {
                ...
                ["select.cancel"] = "取消",
                ["error.balance_empty"] = "[!] 您的API余额已用完。\n请在 z.ai 充值以继续使用。",
                ["error.content_filter"] = "[!] 您的消息被内容过滤器拦截。\n请修改后重试。",
                ["error.invalid_key"] = "[!] API密钥无效。\n请检查密钥并重新登录。",
                ["error.rate_limit"] = "[!] 请求过多。\n请稍后再试。",
                ["error.api_generic"] = "[!] 发生API错误。",
            ...
            ["ja"] = new()
            {
                ...
                ["select.cancel"] = "キャンセル",
                ["error.balance_empty"] = "[!] APIの残高がなくなりました。\nz.ai でトークンを追加してください。",
                ["error.content_filter"] = "[!] メッセージがコンテンツフィルターでブロックされました。",
                ["error.invalid_key"] = "[!] APIキーが無効です。",
                ["error.rate_limit"] = "[!] リクエストが多すぎます。しばらくお待ちください。",
                ["error.api_generic"] = "[!] APIエラーが発生しました。",
